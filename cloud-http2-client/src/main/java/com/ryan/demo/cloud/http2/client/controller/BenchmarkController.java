package com.ryan.demo.cloud.http2.client.controller;

import com.ryan.benchmark.core.api.BenchmarkRequest;
import com.ryan.benchmark.core.api.BenchmarkRunner;
import com.ryan.demo.cloud.http2.client.dto.UserBDTO;
import com.ryan.demo.cloud.http2.client.feign.UserFeignClient;
